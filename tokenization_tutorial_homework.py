# -*- coding: utf-8 -*-
"""tokenization_tutorial.ipynb_The_working_one

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1qZJRpRZ_GHrWTkAAc4PMAJZiqBklgs3H
...
# Вопрос 1: преимуществами гибридной токенизации являются: простота обучения модели, открытый словарь, отсутствие <unk>, что приводит к улучшению перевода
# Вопрос 2: проблемы - большие вычислительные затраты, труднее обучать, нееоднозначность при генерации (может порождать одинаковые последовательности символов для разных слов)
# Вопрос 3: задачи: машинный перевод, морфологический анализ и лемматизация, text-to-speech / speech recognition, обработка имен, которых нет в словаре
